                        ...
                        <div className="col-lg-3 order-2 order-lg-1">
                            ...
                            <ul className="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                                {props.categories.map((category) => {
                                    return <div className="py-2 mb-2 bg-light"><strong className=" text-uppercase font-weight-bold">
                                        <a className="reset-anchor" href={`/category/${category._id}`}>{category.name}</a></strong>
                                    </div>
                                })}
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                            <div className="row mb-3 align-items-center">
                                <div className="col-lg-6 mb-2 mb-lg-0">
                                    <p className="text-normal text-muted mb-0">List category</p>
                                </div>
                                <div className="col-lg-6">
                                                ...
                                                <div className="dropdown-menu" style={{ maxHeight: 629, overflow: 'hidden', minHeight: 132 }}>
                                                    <div className="inner show" role="listbox" id="bs-select-1" tabIndex={-1} style={{ maxHeight: 629, overflowY: 'auto', minHeight: 132 }}>
                                                        <ul className="dropdown-menu inner show" role="presentation" style={{ marginTop: 0, marginBottom: 0 }}>
                                                            ...
                                                            <li>
                                                                <a role="option" className="dropdown-item" id="bs-select-1-2" tabIndex={0} aria-setsize={4} aria-posinset={3}>
                                                                    <span className="text">Price: Low to High</span></a>
                                                            </li>
                                                            <li>
